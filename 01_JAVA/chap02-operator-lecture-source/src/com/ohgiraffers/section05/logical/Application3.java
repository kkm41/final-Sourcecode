...
public class Application3 {
    public static void main(String[] args) {
        ...
        /*
        * AND연산과 OR 연산의 특징
        * 논리식 && 논리식 : 앞에 결과가 false면 뒤를 실행 안함
        * 논리식 || 논리식 : 앞에 결과가 true면 뒤를 실행 안함*/

        /*1. 논리식 && 논리식 : 앞에 결과가 flase면 뒤를 실행 안함 */
        /*
        ...
        * 따라서 연산 횟수를 줄이기 위해서는 &&연산의 경우 앞에 false가 나올 가능성이 높은 조건을 작성하는 것이 좋다*/
        ...
        int result = (false && ++num1 >0)? num1 : num1; // (조건식)? 참일때 사용할 값1 : 거짓일 때 사용할 값2*
